...
/// <summary>
/// HTTP API controller that resolves a YouTube video ID to a playable CDN URL
/// and returns an HTTP 302 redirect for direct play.
///
...
/// calls yt-dlp to obtain the best progressive MP4/H.264/AAC stream URL and redirects to it.
/// </summary>
[ApiController]
[Route("YouTubeSync")]
...
public class YouTubeSyncController : ControllerBase
{
    ...
    /// <returns>302 redirect to the CDN URL, or 503 if no compatible format is found.</returns>
    ...
    public async Task<IActionResult> ResolveVideo(string videoId, CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning(
                "No compatible progressive format available for {VideoId}. Returning 503.",
                videoId);
            return StatusCode(
